		...
		(c.prototype = {
				...
				if (t != this.imageSource)
					if (((this.imageSource = t), this.imageSource)) {
						...
						(r.onload = function () {
							...
							(r.crossOrigin = a(this.imageSource)
								? null
								: this.crossOrigin),
			...
			render: function () {
				s.bindFramebuffer(s.FRAMEBUFFER, null),
					...
					s.uniform1i(
						this.renderProgram.locations.samplerBackground,
						0
					),
			...
			hideCssBackground: function () {
				...
				"none" != e &&
					...
					(this.originalCssBackgroundImage = this.$el.css(
						"backgroundImage"
					)),
